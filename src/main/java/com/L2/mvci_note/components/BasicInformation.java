...
//        pasteButton.setTooltip(ToolTipFx.of("Clear Basic Information"));
    ...
    private Node callInInfo() {
        ...
        textFields[0] = TextFieldFx.createValidatedTextField(200,"Original WO-", StringChecker::formatWorkOrder, noteView);
        textFields[1] = TextFieldFx.createValidatedTextField(200,"Original Case-", StringChecker::formatCaseNumber, noteView);
