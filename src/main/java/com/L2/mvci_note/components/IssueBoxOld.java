...
public class IssueBoxOld implements Component<Region> {

    private final NoteView noteView;
    private final NoteModel noteModel;
    private VBox root;
    private final TextArea textAreaIssue;
    private static final Logger logger = LoggerFactory.getLogger(IssueBoxOld.class);

    public IssueBoxOld(NoteView noteView) {
